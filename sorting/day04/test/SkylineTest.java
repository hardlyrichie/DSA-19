...
public class SkylineTest {
    ...
    @Test
    public void two() {
//        Skyline.Building[] b = buildings(new int[][]{{1, 3, 2}, {2, 4, 1}, {3, 5, 4}, {6, 8, 2}, {7, 9, 1}});
//        List<Skyline.Point> line = Skyline.skyline(b);
//
//        for (Object i : line.toArray()) {
//            System.out.print("["+((Skyline.Point) i).x + ", " + ((Skyline.Point) i).y + "] ");
//        }
    ...
    @Test
    public void four() {
//        Skyline.Building[] b = buildings(new int[][]{{0, 2, 3}, {1, 2, 1}, {5, 7, 3}, {6, 8, 2}, {9, 10, 5}, {9, 10, 4}, {13, 15, 2}, {13, 14, 5}, {15, 17, 5}, {19, 20, 5}});
//        List<Skyline.Point> line = Skyline.skyline(b);
//
//        for (Object i : line.toArray()) {
//            System.out.print("["+((Skyline.Point) i).x + ", " + ((Skyline.Point) i).y + "] ");
//        }
    ...
    @Test
    public void five() {
//        Skyline.Building[] b = buildings(new int[][]{{0, 4, 4}, {1, 8, 2}, {1, 2, 2}, {2, 6, 1}, {4, 11, 3}, {7, 12, 2}, {10, 15, 3}, {11, 12, 5}, {13, 19, 5}, {15, 20, 2}, {16, 18, 5}, {19, 22, 1}, {19, 26, 2}, {20, 23, 1}, {21, 22, 1}, {21, 24, 4}, {21, 25, 4}, {21, 27, 1}, {25, 30, 4}, {25, 32, 4}, {27, 33, 2}, {30, 37, 4}, {32, 39, 1}, {36, 37, 3}, {40, 43, 3}});
//        List<Skyline.Point> line = Skyline.skyline(b);
//
//        for (Object i : line.toArray()) {
//            System.out.print("["+((Skyline.Point) i).x + ", " + ((Skyline.Point) i).y + "] ");
